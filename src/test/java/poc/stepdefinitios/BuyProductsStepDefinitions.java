...
import tasks.demoblaze.*;
import org.json.simple.JSONObject;
import utils.web.DatosParametrizados;
...
public class BuyProductsStepDefinitions {
    ...
    public void completarFormularioDeCompra() throws IOException, org.json.simple.parser.ParseException {
    ...
    public void deberiaVerUnMensajeConfirmacionConIdDeOrdenYMontoTotal() throws IOException, org.json.simple.parser.ParseException {
        JSONObject js = DatosParametrizados.leerJson();
        theActorInTheSpotlight().attemptsTo(
